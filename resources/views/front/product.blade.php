                    ...
                    <div class="carousel-inner bg-light">
                        ...
                        @if ($product->product_images)
                            ...
                            <div class="carousel-item {{ ($key == 0) ? 'active' : '' }}">
                                <img class="w-100 h-100" src="{{ asset('uploads/product/'.$productImage->img) }}" alt="Image">
                            </div>
                            @endforeach                             
                        @endif
            ...
            <div class="col-md-12 mt-5">
                <div class="bg-light">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="reviews-tab" data-bs-toggle="tab" data-bs-target="#reviews" type="button" role="tab" aria-controls="reviews" aria-selected="false">Bình luận, đánh giá</button>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                            <div class="col-md-8">
                                <div class="row">
                                    ...
                                    <h3 class="h4 pb-3">Hãy để lại đánh giá của bạn</h3>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea name="comment"  id="comment" class="form-control" cols="25" rows="8" placeholder="Bạn đã có trải nghiệm như thế nào?"></textarea>
                                        <p></p>
                                    </div>
                                    <div>
                                        @if (Auth::check() == false)
				                        <div>Bạn cần <a href="{{ route('account.login') }}">Đăng nhập</a> để đánh giá sản phẩm</div>
				                        {{-- elseif cần mua mới đánh giá đc --}}
                                ...
                                @if ($product->product_ratings->isNotEmpty())
                                    ...
                                    <div class="rating-group mb-4">
                                        <span> <strong>{{ $rating->username }}</strong></span>
                                         ...
                                         <div class="my-3">
                                            <p style="font-family: sans-serif">{{ $rating->comment }}</p>
