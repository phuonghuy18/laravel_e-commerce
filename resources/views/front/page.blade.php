    ...
    <div class="container">
        <div class="light-font">
            <ol class="breadcrumb primary-color mb-0">
                ...
                <li class="text-uppercase breadcrumb-item">{{ $page->name }}</li>
            </ol>
        </div>
    </div>
</section>

@if ($page->slug == 'lien-he-voi-chung-toi')
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <form class="shake" role="form" method="post" id="contactForm" name="contactForm">
                    <div class="mb-3">
                        <label class="mb-2" for="name">Tên khách hàng</label>
                    ...
                    <div class="mb-3">
                        <label for="message" class="mb-2">Ý kiến</label>
                        <textarea class="form-control" rows="3" id="message" name="message" data-error="Write your message"></textarea>
                        <p class="help-block with-errors"></p>
                    </div>
                  
                    <div class="form-submit">
                        <button class="btn btn-dark" type="submit" id="form-submit"><i class="material-icons mdi mdi-message-outline"></i>Gửi</button>
